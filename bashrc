...
export CPP_LIBS='-lthriftfrozen2 -lthrift -lthriftcpp2 -lfolly   -lfollybenchmark   -lfolly_test_support -lfolly_fingerprint -lboost_context   -lboost_chrono   -lboost_date_time   -lboost_filesystem   -lboost_program_options   -lboost_regex   -lboost_system   -lboost_thread   -lboost_atomic   -lpthread   -ldouble-conversion   -lglog   -levent   -lssl   -lcrypto   -ldouble-conversion   -lglog   -lgflags   -lpthread   -levent   -lssl   -lcrypto   -lz   -llzma   -llz4   -lzstd   -lsnappy   -liberty   -ldl   -lpthread    -lgmock   -lgtest' 
export GCC_FLAGS='-g   -std=c++14   -Werror   -Wall   -Wno-deprecated   -Wdeprecated-declarations   -Wno-error=deprecated-declarations   -Wno-sign-compare   -Wno-unused   -Wno-inconsistent-missing-override   -Wunused-label   -Wunused-result   -Wnon-virtual-dtor   -fopenmp'
