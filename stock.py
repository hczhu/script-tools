...
EPS = {
  ...
  # 根据2014 Q1
  '中国银行': 10**6 * (
              (82092 - 24730 + 28970) * 1.1 # 手续费和佣金净收入，按过去两年的平均增长估计
              + (123923 - 82092 - 10808 + 10107) * 0.8 # 其他非利息收入打八折
              + (13398593 * 1.02) * 2.20 / 100 # 利息净收入 = 生息资产估计 * 净息差估计
              - (124747 - 28046 + 29845)* 1.10 # 减去业务管理费估计
              - (23510 - 8261 + 15096) * 2 # 减去资产减值损失
              ) * (1.0 - 0.225)  # 扣税
              / SHARES['中国银行'],
}
