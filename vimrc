...
au FileType javascript,php,cpp map <C-y> :w<CR>:!g++ -o %:r -std=c++11 -g -O3 -Wl,--no-as-needed -lpthread -lfolly %
au FileType javascript,php,cpp map <C-u> :w<CR>:!g++ -o %:r -std=c++11 -g -O0 -Wl,--no-as-needed -lpthread -lfolly %
